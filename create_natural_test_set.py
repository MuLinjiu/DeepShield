...
def main():
    ...
    test_data = []
    with open("data/processed/llm_input_enriched_test.jsonl", "r", encoding="utf-8") as f:
        for line in f:
    ...
    # 随机采样10000条（保持原始分布）
    print("\n[*] Sampling 10000 samples (natural distribution)...")
    sampled = random.sample(test_data, 10000)
    ...
    # 保存
    output_path = "data/processed/llm_input_enriched_test_natural10k.jsonl"
